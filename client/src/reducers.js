...
import { tagsFilterSearch, tagsFilterLoad, materialsFilterLoad, materialsFilterSearch } from './reducers/tagsFilter';

// These reducers are loaded into redux in index.js
// New reducers must always be added here or they won't do anything
const Reducers = {
    toasts, errors, monumentPage, searchPage, mapPage, tagsFilterSearch, tagsFilterLoad, materialsFilterSearch,
    materialsFilterLoad
};
