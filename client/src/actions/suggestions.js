import {
    APPROVE_BULK_CREATE_SUGGESTION_ERROR,
    APPROVE_BULK_CREATE_SUGGESTION_PENDING,
    APPROVE_BULK_CREATE_SUGGESTION_SUCCESS,
    APPROVE_CREATE_SUGGESTION_ERROR,
    APPROVE_CREATE_SUGGESTION_PENDING,
    APPROVE_CREATE_SUGGESTION_SUCCESS,
    APPROVE_UPDATE_SUGGESTION_ERROR,
    APPROVE_UPDATE_SUGGESTION_PENDING,
    APPROVE_UPDATE_SUGGESTION_SUCCESS,
    FETCH_BULK_CREATE_SUGGESTION_ERROR,
    FETCH_BULK_CREATE_SUGGESTION_PENDING,
    FETCH_BULK_CREATE_SUGGESTION_SUCCESS,
    FETCH_BULK_CREATE_SUGGESTIONS_ERROR,
    FETCH_BULK_CREATE_SUGGESTIONS_PENDING,
    FETCH_BULK_CREATE_SUGGESTIONS_SUCCESS,
    FETCH_CREATE_SUGGESTION_ERROR,
    FETCH_CREATE_SUGGESTION_PENDING,
    FETCH_CREATE_SUGGESTION_SUCCESS,
    FETCH_CREATE_SUGGESTIONS_ERROR,
    FETCH_CREATE_SUGGESTIONS_PENDING,
    FETCH_CREATE_SUGGESTIONS_SUCCESS,
    FETCH_UPDATE_SUGGESTION_ERROR,
    FETCH_UPDATE_SUGGESTION_PENDING,
    FETCH_UPDATE_SUGGESTION_SUCCESS,
    FETCH_UPDATE_SUGGESTIONS_ERROR,
    FETCH_UPDATE_SUGGESTIONS_PENDING,
    FETCH_UPDATE_SUGGESTIONS_SUCCESS,
    REJECT_BULK_CREATE_SUGGESTION_ERROR,
    REJECT_BULK_CREATE_SUGGESTION_PENDING,
    REJECT_BULK_CREATE_SUGGESTION_SUCCESS,
    REJECT_CREATE_SUGGESTION_ERROR,
    REJECT_CREATE_SUGGESTION_PENDING,
    REJECT_CREATE_SUGGESTION_SUCCESS,
    REJECT_UPDATE_SUGGESTION_ERROR,
    REJECT_UPDATE_SUGGESTION_PENDING,
