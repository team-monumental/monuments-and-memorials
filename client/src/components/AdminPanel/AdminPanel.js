        ...
        return (
            <div className="panel">
                ...
                <div className="viewport">
                    ...
                    <ProtectedRoute exact path="/panel/bulk-edit" component={BulkEditPage}
                                    roles={Role.RESEARCHER_OR_ABOVE}/>
                    ...
                    <ProtectedRoute exact path="/panel/manage/monuments" component={ManageMonumentsPage}
                                    roles={Role.RESEARCHER_OR_ABOVE}/>
                    <ProtectedRoute exact path="/panel/manage/monuments/search" component={ManageMonumentsPage}
                                    customProps={{mode: 'search'}} roles={Role.RESEARCHER_OR_ABOVE}/>
                    <ProtectedRoute exact path="/panel/manage/monuments/monument/:monumentId"
                                    component={ManageMonumentsPage} customProps={{mode: 'monument'}}
                                    roles={Role.RESEARCHER_OR_ABOVE}/>
                    <ProtectedRoute exact path="/panel/manage/monuments/monument/update/:monumentId"
                                    component={ManageMonumentsPage} customProps={{mode: 'update'}}
                                    roles={Role.RESEARCHER_OR_ABOVE}/>
                    <ProtectedRoute exact path="/panel/manage/users" component={ManageUsersPage} roles={[Role.ADMIN]}/>
                    <ProtectedRoute exact path="/panel/manage/users/search" component={ManageUsersPage}
                                    customProps={{mode: 'search'}} roles={[Role.ADMIN]}/>
                    <ProtectedRoute exact path="/panel/manage/users/user/:userId" component={ManageUsersPage}
                                    customProps={{mode: 'user'}} roles={[Role.ADMIN]}/>
                    <ProtectedRoute exact path="/panel/manage/suggestions" component={ManageSuggestionsPage}
                                    roles={Role.RESEARCHER_OR_ABOVE}/>
                    <ProtectedRoute exact path="/panel/manage/suggestions/search" component={ManageSuggestionsPage}
                                    customProps={{mode: 'search'}} roles={Role.RESEARCHER_OR_ABOVE}/>
                    <ProtectedRoute exact path="/panel/manage/suggestions/suggestion/:suggestionId"
                                    component={ManageSuggestionsPage} customProps={{mode: 'suggestion'}}
                                    roles={Role.RESEARCHER_OR_ABOVE}/>
                </div>
            </div>
        );
