import {
    ...
    SEARCH_BULK_CREATE_SUGGESTIONS_PENDING, SEARCH_BULK_UPDATE_SUGGESTIONS_PENDING,
    SEARCH_BULK_CREATE_SUGGESTIONS_SUCCESS, SEARCH_BULK_UPDATE_SUGGESTIONS_SUCCESS, SEARCH_BULK_CREATE_SUGGESTIONS_ERROR,
    SEARCH_BULK_UPDATE_SUGGESTIONS_ERROR, GET_PENDING_SUGGESTION_COUNT_PENDING, GET_PENDING_SUGGESTION_COUNT_SUCCESS,
    GET_PENDING_SUGGESTION_COUNT_ERROR
} from '../constants';
...
const bulkUpdateSuggestionInitialState = {
    pending: false,
...
export function bulkUpdateSuggestionSearchPage(state = bulkUpdateSuggestionInitialState, action) {
    return basicReducer(state, bulkUpdateSuggestionInitialState, action, {
        pending: SEARCH_BULK_UPDATE_SUGGESTIONS_PENDING,
        success: SEARCH_BULK_UPDATE_SUGGESTIONS_SUCCESS,
        error: SEARCH_BULK_UPDATE_SUGGESTIONS_ERROR
    });
}
