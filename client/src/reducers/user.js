import {
    UPDATE_EMAIL_ERROR, UPDATE_EMAIL_PENDING, UPDATE_EMAIL_SUCCESS, UPDATE_USER_ERROR, UPDATE_USER_PENDING,
    UPDATE_USER_SUCCESS, UPDATE_USER_RESET, FETCH_FAVORITES_PENDING, FETCH_FAVORITES_SUCCESS, FETCH_FAVORITES_ERROR,
    FETCH_USER_PENDING, FETCH_USER_SUCCESS, FETCH_USER_ERROR
} from '../constants';
